...
public class BorgLevelStats {
    ...
    public BorgLevelStats(int hp, int bAmmoStart, int bAmmoMax, int bAmmoType, int bAmmoReload,
                     int xAmmoStart, int xAmmoMax, int xAmmoType, int xAmmoReload) {
        this.hp = hp;
