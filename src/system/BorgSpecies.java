...
public class BorgSpecies {
    ...
    private LevelProperties[] allLevelProperties;
    ...
    public LevelProperties[] getAllLevelProperties() throws IOException {
        if (allLevelProperties == null) {
            allLevelProperties = BorgUtils.getLevelProperties(id);
        }
        return allLevelProperties;
    }
